...
library MintNow {
    ...
    function _startedAndNotExpired(IGeotokenAuction auction, uint256 id)
        private
        view
        returns (bool)
    {
    ...
    function _isOwner(IGeotokenAuction auction, uint256 id)
        private
        view
        returns (bool)
    {
    ...
    function _mintNowPrice(IGeotokenAuction auction, uint256 id)
        internal
        view
        returns (uint256)
    {
    ...
    function _mintNowFee(IGeotokenAuction auction, uint256 id)
        internal
        view
        returns (uint256)
    {
    ...
    function _mintNowPriceWithFee(IGeotokenAuction auction, uint256 id)
        internal
        view
        returns (uint256)
    {
